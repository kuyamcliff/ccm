...
const STEPS: Step[] = [
  ...
  {
    name: "legal_pages.title_fr",
    sql: "ALTER TABLE legal_pages ADD COLUMN IF NOT EXISTS title_fr text",
  },
  {
    name: "legal_pages.body_fr",
    sql: "ALTER TABLE legal_pages ADD COLUMN IF NOT EXISTS body_fr text",
  },
  {
    name: "legal_pages.title_fr backfill",
    sql: "UPDATE legal_pages SET title_fr = title WHERE title_fr IS NULL",
  },
  {
    name: "legal_pages.body_fr backfill",
    sql: "UPDATE legal_pages SET body_fr = body WHERE body_fr IS NULL",
  },
];
