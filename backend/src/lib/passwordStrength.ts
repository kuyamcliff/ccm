 ...
 *
 * This module is the authority. `frontend/src/lib/passwordStrength.ts` mirrors
 * it so somebody sees the problem while typing instead of at submit, but every
 * route validates here regardless of what the browser decided.
 */
