...
const GROUPS: { title: string; items: Item[] }[] = [
  ...
  { title: "Website", items: [{ to: "/desk/insights", label: "Insights", icon: "chart", scope: "insights" }, { to: "/desk/settings", label: "Settings", icon: "settings", scope: "settings" }, { to: "/desk/site-control", label: "Site control", icon: "settings", topOwner: true }, { to: "/desk/translations", label: "Translations", icon: "globe", scope: "settings" }, { to: "/desk/legal", label: "Terms and privacy", icon: "receipt", scope: "legal" }, { to: "/desk/log", label: "Audit log", icon: "shield", owner: true }, { to: "/desk/access", label: "Access", icon: "lock", topOwner: true }] },
];
