...
export const orderApi = {
  ...
  pay: (orderNo: string, momoPhone: string, wallet: WalletId, idempotencyKey: string) =>
    http.post<{ reference: string; order_no: string; amount_fcfa: number; momo_phone: string; expires_in_seconds: number; status: "pending"; payment_url?: string | null }>(
