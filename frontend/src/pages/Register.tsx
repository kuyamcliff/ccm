    ...
    <div className="auth-layout">
      ...
      <div className="auth-brand-panel" aria-hidden="true">
        ...
        <div className="auth-brand-center">
          <p className="auth-brand-big">Join<br />the<br />table.</p>
        </div>
        <div className="auth-brand-bottom">
          <blockquote className="auth-brand-quote">
            An account lets you book, track your tables, and download receipts.
          </blockquote>
      ...
      <div className="auth-form-panel">
        <div className="auth-form-inner">
          <p className="eyebrow animate-up">Join the table</p>
          <h1 className="page-title animate-up delay-1">Create an account</h1>
